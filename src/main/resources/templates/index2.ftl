...
<!--css-->
<link rel="stylesheet" type="text/css" href="${ctx!}/public/home/css/common.css" />
<link rel="stylesheet" type="text/css" href="${ctx!}/public/home/css/index.css" />
<link rel="stylesheet" type="text/css" href="${ctx!}/public/home/css/order_style.css" />
<link rel="stylesheet" type="text/css" href="${ctx!}/public/home/css/slider.css" >
<!--javascript-->
...
<script  type="text/javascript">
	$(function(){
	$("img.lazy").lazyload({
		placeholder : "${ctx!}/public/home/images/images/grey.png",
		effect : "fadeIn",
		threshold : 600
  });
});
</script>
<script type="text/javascript" src="${ctx!}/public/home/js/test.js"></script>

<script src="${ctx!}/public/home/js//order.js" type="text/javascript"></script>
<script src="${ctx!}/public/home/js//utils.js" type="text/javascript"></script>
...
<form action="#" method="post" name="theForm" id="theForm"  target="_blank" onsubmit="return false">
...
<div class="chpr_list">
    <dl class="clearfix">
        ...
        <a  data-jg="490" data-suk="零售客户 490元（1盒装）" data-fc="490" >
				...
				<em class="f_cur" style=""><img alt="" src="${ctx!}/public/home/images/cur_pic03.gif"></em>
				<em class="d_cur" style=""><img alt="" src="${ctx!}/public/home/images/cur_pic02.gif"></em>
                ...
                <div class="layer_r">
                    <div><img src="${ctx!}/public/home/images/layer_pic01.png" alt=""></div>
                    ...
                    <div style="margin-left:11px;"><img src="${ctx!}/public/home/images/layer_pic03.png" alt=""></div>
                </div>
            </a>
    ...
    <div class="paykind">
        ...
        <div class="paykind_box01" id="checkout_form_box">
            <ul>
                <li>
                    <label>收货姓名：</label>
                    <input class="col_c" name="userName" id="name" onblur="consigneeSet(this.value)" size="30">
                    <span id="consignee_notice"></span>
                </li>
            <script type="text/javascript" src="${request.contextPath}/js/bddq.js" charset="gb2312"></script>
                <li>
                <label>收货地区：</label>
				...
				<script type="text/javascript" src="${request.contextPath}/js/bdbd.js"></script>
                </li>
                ...
                <li>
                    <label>联系电话：</label>
                    <input class="col_c"  name="phone" id="tel" maxlength="13"  size="30">
...
src="${ctx!}/public/home/images/index/pay_pic01.jpg">
            </label><br>-->
            <!--<label>
...
src="${ctx!}/public/home/images/index/pay_pic02.jpg">
            </label><br/>
            <label>
            <input type="radio" onclick="javascript:select_pay(8);" value="8" name="pay_id" 

id="payid_8"/>快钱支付（折上再享95折）<img src="${ctx!}/public/home/images/index/pay_pic04.png">
            </label><br/>-->
...
t=1441175749"></script>
	...
	<br />
	<input id="submitBtn" src="${ctx!}/public/home/images/click_btn04.jpg" type="image"></div>
</div>
</form>
        ...
        $('#submitBtn').click(function() {
        	//alert($('#theForm').serialize());
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "${request.contextPath}/order/addOrder",
