...
for(i=0;i<22;i++){
	...
	quotes=new Array
	quotes[1]='<p>订购的加拿大u-max 2盒装已发货 <font color="#FF0000">√</font></p>'
	quotes[2]='<p>订购的加拿大u-max 4盒装已发货 <font color="#FF0000">√</font></p>'
	quotes[3]='<p>订购的加拿大u-max 8盒装已发货 <font color="#FF0000">√</font></p>'
	quotes[4]='<p>订购的加拿大u-max 12盒装已发货 <font color="#FF0000">√</font></p>'
	var quote=quotes[rand1]
	document.write(quote)
	document.write('<br>');
}
